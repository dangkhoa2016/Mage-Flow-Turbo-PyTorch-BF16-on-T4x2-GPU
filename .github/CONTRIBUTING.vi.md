...
- có khả năng tái lập;
- nói rõ có ảnh hưởng closed qualified authority hay không;
...
Các file được liệt kê trong `authority/runtime-baseline.json` là runtime authority file đã byte-qualified. Nếu thay đổi một file trong số đó, phải nói rõ byte-equivalence với closed qualified authority không còn được giữ và xác định có cần requalification hay không.
